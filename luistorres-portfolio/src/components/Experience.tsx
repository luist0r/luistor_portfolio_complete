...
const Experience = () => {
  return (
    <section id="experience" className="py-24 px-6 md:px-12 bg-brutal-white">
      <div className="container mx-auto">
        <div className="mb-16">
          <h2 className="text-5xl md:text-7xl font-black mb-4 inline-block bg-brutal-black text-brutal-white px-4 py-2">
            ALTRUISTIC EXPERIENCE
          </h2>
          <p className="font-inter text-xl mt-4 font-bold text-brutal-black">PROFESSIONAL TRACK RECORD & LEADERSHIP</p>
        </div>

        <div className="border-brutal overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead className="bg-brutal-black text-brutal-white font-oswald uppercase text-xl">
              <tr>
                <th className="p-6 border-r-3 border-brutal-black">Role / Project</th>
                <th className="p-6 border-r-3 border-brutal-black">Company</th>
                <th className="p-6 border-r-3 border-brutal-black">Period</th>
            ...
            <tbody className="font-inter">
              {experiences.map((exp, idx) => (
                <React.Fragment key={idx}>
                  <tr className="border-t-3 border-brutal-black hover:bg-brutal-yellow transition-colors cursor-pointer group">
                    <td className="p-6 border-r-3 border-brutal-black font-bold text-lg">{exp.role}</td>
                    <td className="p-6 border-r-3 border-brutal-black font-bold">{exp.company}</td>
                    <td className="p-6 border-r-3 border-brutal-black whitespace-nowrap">{exp.period}</td>
                    <td className="p-6">{exp.location}</td>
                  </tr>
                  <tr className="border-t-3 border-brutal-black bg-brutal-white">
                    <td colSpan={4} className="p-8 text-lg leading-relaxed text-gray-700 font-medium">
                      <div className="flex gap-4">
                        <div className="w-2 bg-brutal-red"></div>
                        <div>{exp.desc}</div>
                      </div>
                    </td>
                  </tr>
        ...
        <div className="grid md:grid-cols-2 mt-12 gap-8">
          <div className="cell-brutal p-8 bg-brutal-white">
            <h3 className="text-3xl font-black mb-4">EDUCATION</h3>
          ...
          <div className="cell-brutal p-8 bg-brutal-red text-brutal-white">
            <h3 className="text-3xl font-black mb-4">COMPETENCIES</h3>
            <div className="flex flex-wrap gap-2">
              {["Strategy", "Operations", "Public Policy", "Economic Development", "Data Analysis", "AI Productivity", "Negotiation", "Partnerships"].map((skill, i) => (
                <span key={i} className="border-brutal bg-brutal-white text-brutal-black px-3 py-1 font-oswald font-bold uppercase text-sm">
                  {skill}
                </span>
              ))}
            </div>
